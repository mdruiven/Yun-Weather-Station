/* Mike Druiven, Aug 6, 2016
 * Source code taken from Internet of Things with the Arduino Yun by Marco Schwartz
 * Save Arduino Yun data to a spreadsheet at https://temboo.com/arduino/yun/update-google-spreadsheet
 * Build a weather station using a photoresistor for light level.
